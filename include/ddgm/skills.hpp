...
const std::vector<Skill> skills = {
    ...
    // Mage
    Skill("Fire Pact", 2, Skill::SkillType::fire, 1.6),
    Skill("Ice Pact", 2, Skill::SkillType::ice, 1.6),
    Skill("Thunder Pact", 2, Skill::SkillType::thunder, 1.6),
    Skill("Holy Pact", 2, Skill::SkillType::holy, 1.6),
    Skill("Dark Pact", 2, Skill::SkillType::dark, 1.6),
    ...
    Skill("High Spellscrean", 2, Skill::SkillType::none, 0),
    ...
    Skill("Fire Affinity", 2, Skill::SkillType::fire, 1.2),
    Skill("Ice Affinity", 2, Skill::SkillType::ice, 1.2),
    Skill("Thunder Affinity", 2, Skill::SkillType::thunder, 1.2),
    Skill("Holy Affinity", 2, Skill::SkillType::holy, 1.2),
    Skill("Dark Affinity", 2, Skill::SkillType::dark, 1.2),
    ...
    Skill("Sacrifice", 5, Skill::SkillType::dark, 50)};
} // namespace ddgm
#endif